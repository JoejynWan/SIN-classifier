...
FULL_DET_FRAMES_JSON = 'results/example_test_set/example_test_set_full_det_frames.json' #Defaults to '[OUTPUT_DIR]/basename(INPUT_DIR)_full_det_frames.json'
...
CHECK_ACCURACY = True
MANUAL_ID_CSV = 'results/example_test_set/example_test_set_manual_id.csv' #Defaults to '[OUTPUT_DIR]/basename(INPUT_DIR)_manual_ID.csv'
